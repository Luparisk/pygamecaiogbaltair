...
SPRITE_FACES_RIGHT = False  # se o sprite original já olhar para a direita, troque para True
...
STORY_AFTER_LORD = [
    "O nightmare final enfim acabou.",
    "Você sobreviveu à floresta, ao circo, ao laboratório e ao pesadelo final.",
...
PLAYER_BULLETS = {
    "potion": load_image(ASSET_DIR / "characters/bruxinha/shoot/potion.png", (26, 26)),
    "triple": load_image(ASSET_DIR / "characters/vampiro/shoot/bullet.png", (20, 20)),
    "fireball": load_image(ASSET_DIR / "characters/dragaozinho/shoot/fireball.png", (30, 30)),
    "boomerang": load_image(ASSET_DIR / "characters/esqueleto/shoot/boomerang.png", (28, 28)),
}
...
BOSS_VISUALS = {
    ...
    "frank": {
        "bg": load_image(ASSET_DIR / "bosses/frank/lab_bg/lab_bg.jpeg", (BOSS_W, BOSS_H)),
        ...
        "spark": load_image(ASSET_DIR / "bosses/frank/spark/spark.png", (12, 12)),
...
print("SPIKE =", BOSS_VISUALS["clown"]["spike"])
        ...
        if self.visible:
            ...
            if img and img.frames:
                ...
                pygame.draw.rect(
                    surf,
                    (20, 20, 20),
                    pygame.Rect(head.x - 2, head.y - 6, head.w + 4, 16),
                    border_radius=4
                )
...
def run_boss_frank(character, carried_player=None):
    ...
    doctor = DrFrankenstein(BOSS_VISUALS["frank"]);monster = MonsterPhase(BOSS_VISUALS["frank"]); phase = 1; tick = 0
    while True:
